      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <div className="font-bold text-xl">Kalyan Kallepalli</div>
            <div className="text-slate-300 mt-1">Software Test Engineer</div>
          </div>
        ...
        <div className="border-t border-slate-700 mt-6 pt-6 flex flex-col md:flex-row justify-between items-center">
          <div className="text-slate-400 text-sm mb-4 md:mb-0">
            &copy; {currentYear} Kalyan Kallepalli. All rights reserved.
          </div>
          <div className="flex space-x-4">
            <a href="https://github.com/SriSatyaKalyan" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition-colors">
            ...
            <a href="https://www.linkedin.com/in/kalyan-kallepalli/" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
